                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user4.jpg')}}" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user5.jpg')}}" alt="user">
                                                    </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user6.jpg')}}" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user7.jpg')}}" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user8.jpg')}}" alt="user">
                                                    </li>
                                                    <li class="avatar avatar-sm"><span class="badge">+4</span>
                                                    </li>
                                                </ul>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list">
                                                    ...
                                                    <li class="avatar avatar-sm"><img class="rounded-circle"
                                                            src="{{asset('admin/assets/images/user/user9.jpg')}}" alt="user">
                                                    </li>
