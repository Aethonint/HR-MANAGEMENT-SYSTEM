 <nav class="navbar">
    ...
    src="{{ $user->profile && $user->profile->profile_picture 
        ...
        : asset('assets/images/user/usrbig3.jpg') }}" 
                        ...
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
                                <ul class="user_dw_menu">
                                    <li>
                                        <a href="{{url('super-admin/profile')}}">
    ...
    <form method="POST" action="{{ route('logout') }}" id="logout-form">
        @csrf
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="flex items-center gap-2">
